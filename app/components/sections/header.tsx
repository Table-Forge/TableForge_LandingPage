    ...
    return (
        ...
        >
            <div className="mx-auto flex h-20 max-w-6xl items-center justify-between gap-4 px-6 md:px-10">
                <a href="#topo" className="inline-flex items-center gap-2 drop-shadow-[0_0_18px_rgba(255,36,0,0.35)]">
                    <img src={LOGO_MARK_URL} alt="TableForge" className="h-12 w-auto" />
                    <img src={LOGO_TEXT_URL} alt="" aria-hidden="true" className="hidden h-7 w-auto sm:block" />
                </a>
